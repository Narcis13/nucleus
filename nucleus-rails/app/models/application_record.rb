class ApplicationRecord < ActiveRecord::Base
  ...
  # Sets the Postgres GUC `app.professional_id` that RLS policies on
  # tenant-scoped tables read, and downgrades to the Supabase `authenticated`
  # role for the duration of the block.
  #
