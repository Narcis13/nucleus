...
ActiveRecord::Schema[8.1].define(version: 2026_04_23_200940) do
  ...
  create_table "public.ahoy_events", force: :cascade do |t|
    t.string "name"
    t.jsonb "properties"
    t.datetime "time"
    t.bigint "user_id"
  ...
  create_table "public.ahoy_visits", force: :cascade do |t|
  ...
  create_table "public.pay_charges", force: :cascade do |t|
  ...
  create_table "public.pay_customers", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.jsonb "data"
    t.boolean "default"
  ...
  create_table "public.pay_merchants", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.jsonb "data"
    t.boolean "default"
    t.bigint "owner_id"
  ...
  create_table "public.pay_payment_methods", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "customer_id", null: false
    t.jsonb "data"
    t.boolean "default"
  ...
  create_table "public.pay_subscriptions", force: :cascade do |t|
  ...
  create_table "public.pay_webhooks", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.jsonb "event"
    t.string "event_type"
    t.string "processor"
